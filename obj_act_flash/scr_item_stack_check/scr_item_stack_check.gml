...
{
	//同一IDかつamountがまだmaxではないなら
	if(moveto.inventory[ss_x, ss_y] == click_id) and (moveto.inventory_amount[ss_x, ss_y] < to_amount_max)
	{
...
//ループを抜けたら、とりあえずamountを登録
inventory_amount[click_inv_x, click_inv_y] = click_amount;